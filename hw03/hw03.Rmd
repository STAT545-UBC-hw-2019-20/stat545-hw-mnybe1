...
```{r}
(ggplot(gapminder, aes(year, pop,group=continent)) + geom_jitter()) #To quickly explore the dataframe. 2 countries are clear outliers in this dataframe. 

(China <- gapminder %>% filter(pop>250000000 | pop<1500000) %>%
