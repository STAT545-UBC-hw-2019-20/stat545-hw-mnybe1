...
*Table 1.* The spread of GDP within continents. For each country, the min, max, mean and the difference between the minimum and maxiumum values has been calculated
